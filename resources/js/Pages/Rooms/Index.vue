...
function destroy(id) {
  if (confirm('Xoá phòng?')) router.delete(route('rooms.destroy', id), { preserveScroll: true })
}
      ...
      <Column header="" style="width: 180px">
        <template #body="{ data }">
          <div class="flex gap-2 justify-end">
            <Link :href="route('rooms.edit', data.id)" class="px-3 py-1.5 rounded border border-emerald-300 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-700 dark:text-emerald-300 dark:hover:bg-emerald-900/20">
