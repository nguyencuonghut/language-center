...
function refreshPreview(){
  ...
  router.visit(route('admin.invoices.edit', { invoice: props.invoice.id, ...q }), {
    preserveScroll: true,
    preserveState: true,
    only: ['defaults'],
  })
...
function update(){
  ...
  form.saving = true
  router.put(route('admin.invoices.update', { invoice: props.invoice.id }), {
...
<template>
  ...
  <div class="mb-3 flex justify-between items-center">
    ...
    <div class="flex gap-2">
      <Link
        :href="route('admin.invoices.show', { invoice: invoice.id })"
  ...
  <div class="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 max-w-2xl mx-auto">
    <div class="flex flex-col gap-4">
      ...
      <div class="flex justify-end gap-2 mt-4">
        <Link :href="route('admin.invoices.show', { invoice: invoice.id })" class="px-3 py-2 rounded border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800">
          Huỷ
        </Link>
