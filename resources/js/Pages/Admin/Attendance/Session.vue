...
function save(){
  ...
  router.post(route('admin.attendance.store', { session: props.session.id }), { items }, {
    preserveScroll: true
  })
}
...
<template>
  <Head :title="`Điểm danh - ${classroom?.name || ''} - Admin`" />

  <div class="mb-3 flex items-center justify-between">
    <div>
      <h1 class="text-xl md:text-2xl font-heading font-semibold">Điểm danh - Admin</h1>
