...
const form = useForm({
  ...
  start_date: props.classroom.start_date, // yyyy-mm-dd hoặc Date → convert trước khi submit
...
function submit() {
  ...
  form.transform(() => payload).put(route('admin.classrooms.update', props.classroom.id))
}
</script>
