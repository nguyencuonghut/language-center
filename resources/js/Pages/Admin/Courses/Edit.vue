...
const props = defineProps({
  course: {
    type: Object,
    required: true // {id, code, name, audience, language, active}
  },
  audiences: {
    type: Array,
    default: () => [
...
const form = reactive({
  ...
  audience: props.course?.audience ?? null,
  language: props.course?.language ?? null,
...
<template>
  <Head :title="`Sửa khóa học · ${course.name}`" />

  <div class="mb-3 flex justify-between items-center">
    <h1 class="text-xl md:text-2xl font-heading font-semibold">Sửa khoá học</h1>
