            ...
            <Card>
                <template #title>
                    <div class="flex justify-between items-center">
                        <span>Kết quả tìm kiếm ({{ transfers.total || 0 }} bản ghi)</span>
                ...
                <template #content>
                    ...
                    >
                        ...
                        <Column field="student" header="Học viên">
                            <template #body="{ data }">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">{{ data.student?.code }}</div>
                                </div>
                            </template>
                        </Column>
                            ...
                            <template #body="{ data }">
                                <div class="space-y-1">
                                    <div class="flex items-center text-sm">
                                        <span class="text-gray-500 mr-2">Từ:</span>
                                        <span class="font-medium">{{ data.from_class?.code }}</span>
                                    </div>
                                    <div class="flex items-center text-sm">
                                        <span class="text-gray-500 mr-2">Đến:</span>
                        ...
                        <Column field="created_by" header="Người tạo">
                            <template #body="{ data }">
                                <div>
                                    <div class="font-medium">{{ data.created_by?.name }}</div>
                        ...
                        <Column field="last_action" header="Hành động cuối">
                            <template #body="{ data }">
                                <div class="space-y-1">
                                    <div v-if="data.reverted_at" class="text-sm text-red-600">
                                        <i class="pi pi-undo mr-1"></i>
                                        Đã hoàn tác
                                    </div>
                                    <div v-if="data.retargeted_at" class="text-sm text-blue-600">
                                        <i class="pi pi-arrow-right mr-1"></i>
                                        Đã đổi hướng
                                    </div>
                                    <div v-if="!data.reverted_at && !data.retargeted_at" class="text-sm text-gray-500">
                                        Không có
                                    </div>
                                </div>
                            </template>
