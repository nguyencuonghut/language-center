    ...
    <div class="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 space-y-4">
      <div class="grid md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <InputNumber v-model="form.capacity" class="w-full" :min="1" :max="1000" />
      ...
      <div class="flex items-center gap-2">
        ...
        <Link :href="route('manager.rooms.index')" class="px-3 py-2 rounded-lg border hover:bg-slate-50 dark:hover:bg-slate-700/30">
          Quay lại
        </Link>
      </div>
    </div>
