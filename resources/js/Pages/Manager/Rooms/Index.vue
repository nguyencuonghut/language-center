...
<template>
  ...
  <div class="mb-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <Link :href="route('manager.rooms.create')" class="px-3 py-2 rounded-lg bg-emerald-600 text-white hover:bg-emerald-700">
      ...
      <Column header="" style="width: 180px">
        <template #body="{ data }">
          <div class="flex gap-2 justify-end">
            <Link :href="route('manager.rooms.edit', data.id)" class="px-3 py-1.5 rounded border border-emerald-300 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-700 dark:text-emerald-300 dark:hover:bg-emerald-900/20">
