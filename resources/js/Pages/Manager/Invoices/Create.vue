...
function refreshPreview(){
  ...
  router.visit(route('manager.invoices.create', q), {
    preserveScroll: true,
    preserveState: true,
...
function save() {
  ...
  form.saving = true
  router.post(route('manager.invoices.store'), {
...
<template>
  ...
  <div class="mb-3 flex justify-between items-center">
    ...
    <Link :href="route('manager.invoices.index')" class="px-3 py-2 text-sm rounded border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800">
      ← Quay lại danh sách
    </Link>
  </div>
  ...
  <div class="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-4 max-w-2xl mx-auto">
    <div class="flex flex-col gap-4">
      ...
      <div class="flex justify-end gap-2 mt-4">
        <Link :href="route('manager.invoices.index')" class="px-3 py-2 rounded border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-800">
          Huỷ
        </Link>
