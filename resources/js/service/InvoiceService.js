...
/**
 * Service cho hóa đơn học phí (Invoices)
...
export const createInvoiceService = () => ({
   ...
   */
  getList(params = {}) {
    router.visit(route('admin.invoices.index', params), {
      preserveScroll: true,
      preserveState: true,
    })
  },
   ...
   */
  show(id, params = {}) {
    router.visit(route('admin.invoices.show', id), {
      data: params,
      preserveScroll: true,
      preserveState: true,
    })
  ...
  create(data, callbacks = {}) {
    router.post(route('admin.invoices.store'), data, {
  ...
  update(id, data, callbacks = {}) {
    router.put(route('admin.invoices.update', id), data, {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
  ...
  addItem(invoiceId, data, callbacks = {}) {
    router.post(route('admin.invoices.items.store', invoiceId), data, {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
  ...
  updateItem(invoiceId, itemId, data, callbacks = {}) {
    router.put(route('admin.invoices.items.update', { invoice: invoiceId, item: itemId }), data, {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
  ...
  deleteItem(invoiceId, itemId, callbacks = {}) {
    ...
    router.delete(route('admin.invoices.items.destroy', { invoice: invoiceId, item: itemId }), {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
  ...
  recordPayment(invoiceId, data, callbacks = {}) {
    router.post(route('admin.invoices.payments.store', invoiceId), data, {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
  ...
  deletePayment(invoiceId, paymentId, callbacks = {}) {
    ...
    router.delete(route('admin.invoices.payments.destroy', { invoice: invoiceId, payment: paymentId }), {
      preserveScroll: true,
      onSuccess: () => callbacks.onSuccess?.(),
      onError:   (errors) => callbacks.onError?.(errors),
      onFinish:  () => callbacks.onFinish?.(),
